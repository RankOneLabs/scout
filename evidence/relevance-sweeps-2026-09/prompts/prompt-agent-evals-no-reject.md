...
Score 0.0-0.39 when the post is not substantively about evaluating agents: generic model leaderboard chatter, consumer AI news, hype, funding, event promotion, or posts about a benchmark's namesake that have nothing to do with evaluation.
