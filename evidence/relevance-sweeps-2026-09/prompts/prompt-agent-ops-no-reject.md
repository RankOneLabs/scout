...
Score 0.0-0.39 when the post is not substantively about operating AI agents: consumer assistant chatter, hardware, model benchmarks, research papers, event or podcast promotion, business news, or generic future-of-agents hype.
