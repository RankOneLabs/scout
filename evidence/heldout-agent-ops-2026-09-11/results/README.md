...
| File | Contents |
|---|---|
| [comparison.json](comparison.json) | Model metrics, paired intervals, costs, verification counts, and all 40 cases’ finalized human labels and model predictions, keyed by evaluation/group ID. No post text. |
